...
class TpDataApiGetPaymentsSearchParams extends \dlds\thepay\api\dataApi\TpDataApiObject {
    ...
    {
        $this->accountId = \dlds\thepay\api\dataApi\TpValueFormatter::formatList('int', $accountId);
    }
    ...
    {
        $this->state = \dlds\thepay\api\dataApi\TpValueFormatter::formatList('int', $state);
    }
    ...
    {
        $this->currency = \dlds\thepay\api\dataApi\TpValueFormatter::formatList('int', $currency);
    }
    ...
    {
        $this->createdOnFrom = \dlds\thepay\api\dataApi\TpValueFormatter::format(
    ...
    {
        $this->createdOnTo = \dlds\thepay\api\dataApi\TpValueFormatter::format('DateTime', $createdOnTo);
    }
    ...
    {
        $this->finishedOnFrom = \dlds\thepay\api\dataApi\TpValueFormatter::format(
    ...
    {
        $this->finishedOnTo = \dlds\thepay\api\dataApi\TpValueFormatter::format(
    ...
    {
        $this->accounting = \dlds\thepay\api\dataApi\TpValueFormatter::formatList('int', $accounting);
    }
    ...
    {
        $this->method = \dlds\thepay\api\dataApi\TpValueFormatter::formatList('int', $method);
    }
    ...
    {
        $this->specificSymbol = \dlds\thepay\api\dataApi\TpValueFormatter::format(
