...
class TpDataApiSignature {
    ...
    public static function compute(array $data, $password = null)
    {
        ...
        {
            throw new \dlds\thepay\api\exceptions\TpMissingParameterException('password');
        }
        ...
        $processed = \dlds\thepay\api\dataApi\processors\TpDataApiDigester::process($data);
        return $processed;
    }
    ...
    public static function validate(array $data, $password, $signature = null)
    {
        ...
        if ($signatureIsNull)
        {
            ...
            {
                throw new \dlds\thepay\api\exceptions\TpMissingParameterException('signature');
            }
        ...
        {
            throw new \dlds\thepay\api\exceptions\TpInvalidSignatureException;
        }
    }
}